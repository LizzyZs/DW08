 ...
 */
    ...
    if(!isset($_SESSION["products"])){
        $arrProduct = [
                ...
                ["id"=>6, "nom"=>"Mini pye de limón",  "tip"=>"Bocaditos", "subti"=>"Dulces", "img"=>"dulces6.jpg"],
                ...
                ["id"=>9, "nom"=>"Mini triple de jamón y pollo",  "tip"=>"Bocaditos", "subti"=>"Salados", "img"=>"salados3.jpg"],
                ...
                ["id"=>12, "nom"=>"Cuadraditos de jamón y queso",  "tip"=>"Bocaditos", "subti"=>"Salados", "img"=>"salados6.jpg"],
                ...
                ["id"=>16, "nom"=>"Ají de gallina",  "tip"=>"Buffet Criollo", "subti"=>"Platos clásicos", "img"=>"platosC1.jpg"],
                ["id"=>17, "nom"=>"Seco de res",  "tip"=>"Buffet Criollo", "subti"=>"Platos clásicos", "img"=>"platosC2.jpg"],
                ["id"=>18, "nom"=>"Carapulcra",  "tip"=>"Buffet Criollo", "subti"=>"Platos clásicos", "img"=>"platosC3.jpg"],
                ...
                ["id"=>28, "nom"=>"Soufflé de acelga y espinaca",  "tip"=>"Buffet Internacional", "subti"=>"Entradas", "img"=>"entradaI1.jpg"],
                ["id"=>29, "nom"=>"Pastel de poro y tocino",  "tip"=>"Buffet Internacional", "subti"=>"Entradas", "img"=>"entradaI2.jpg"],
                ["id"=>30, "nom"=>"Salpicón de pollo",  "tip"=>"Buffet Internacional", "subti"=>"Entradas", "img"=>"entradaI3.jpg"],
                ...
                ["id"=>40, "nom"=>"Arroz árabe",  "tip"=>"Buffet Internacional", "subti"=>"Complementos", "img"=>"complementosI1.jpg"],
                ...
                ["id"=>43, "nom"=>"Mousse de lúcuma con salsa de vainilla",  "tip"=>"Buffet Internacional", "subti"=>"Postres limeños", "img"=>"postresI1.jpg"],
                ["id"=>44, "nom"=>"Suspiro a la limeña",  "tip"=>"Buffet Internacional", "subti"=>"Postres limeños", "img"=>"postresI2.jpg"],
                ["id"=>45, "nom"=>"Crema volteada",  "tip"=>"Buffet Internacional", "subti"=>"Postres limeños", "img"=>"postresI3.jpg"]
            ];
    }else{
